...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [AuthFormWrapperComponent, ButtonComponent, ReactiveFormsModule, CommonModule, RouterLink, InputComponent],
...
export class LoginComponent {
  ...
  constructor(private swal: SweetAlertService, private toaster: ToasterService, private router: Router) {
